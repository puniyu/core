...
## [0.8.1](https://github.com/puniyu/puniyu/compare/puniyu_event-v0.8.0...puniyu_event-v0.8.1)

### ⚙️ 杂项


- Updated the following local packages: puniyu_adapter_types, puniyu_runtime, puniyu_bot - ([0000000](https://github.com/puniyu/puniyu/commit/0000000))
